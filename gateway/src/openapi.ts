...
export const openApiDocument = {
  ...
  tags: [
    ...
    { name: "Chat",          description: "Streaming chat completions and conversation history" },
    ...
    { name: "License",       description: "Version lock / license manifest status" }
  ],
  ...
  paths: {
    ...
    "/api/health": {
      get: {
        ...
        description: "Always returns 200 if the process is running. Does not check Postgres or Redis. Use /api/status for a full readiness check.",
    ...
    "/api/status": {
      get: {
        ...
        description: "Aggregated health of Postgres, Redis, and any configured external mirrors. Safe for public access — returns no key data.",
        operationId: "getStatus",
        responses: {
          "200": { description: "All systems operational" },
          "207": { description: "Degraded — some services unhealthy" },
    ...
    "/api/keys": {
      get: {
        ...
        description: "Returns metadata only — the raw key value is never returned. Each entry includes a masked hint (e.g. `sk-...abc`).",
                ...
                schema: {
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      category:  { type: "string", enum: ["chat", "image", "search", "code"] },
                      label:     { type: "string", nullable: true },
                      keyHint:   { type: "string", example: "sk-ant-...xyz" },
      ...
      post: {
        ...
        description: "Upserts a key by provider ID. Immediately invalidates the health cache for this provider.",
        operationId: "saveKey",
        requestBody: {
          required: true,
          content: {
            "application/json": {
              schema: {
                ...
                properties: {
                  provider: {
                    ...
                    pattern: "^[a-z0-9-]+$",
                    example: "anthropic",
                    description: "Lowercase alphanumeric provider ID"
                  },
                  key: {
                    type: "string",
                    minLength: 8,
              ...
              examples: {
                anthropic: {
                  ...
                  value: { provider: "anthropic", key: "sk-ant-api03-...", category: "chat" }
                },
                openai: {
                  summary: "OpenAI key",
                  value: { provider: "openai", key: "sk-proj-...", category: "chat" }
                },
                stability: {
                  summary: "Stability AI key",
                  value: { provider: "stability", key: "sk-...", category: "image" }
                },
                brave: {
                  summary: "Brave Search key",
                  value: { provider: "brave", key: "BSAe...", category: "search" }
                }
              }
            }
          }
        ...
        responses: {
          "201": { description: "Key saved — returns metadata (no raw key)" },
    ...
    "/api/keys/introspect": {
      post: {
        ...
        description: "Tests a raw key against all known providers simultaneously. Returns which providers accepted it and their capabilities. The key is never persisted.",
          ...
          content: {
            "application/json": {
              schema: {
                ...
                required: ["key"],
                properties: {
                  key: { type: "string", minLength: 8, example: "sk-ant-api03-..." }
                }
              }
            }
          }
        ...
        responses: {
          "200": { description: "Discovery result — matched providers and capabilities" },
          "422": { description: "Validation error" }
        }
      }
    },
            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  model:           { type: "string", example: "claude-sonnet-4-6", description: "Model ID from GET /api/models" },
                  cascadeEnabled:  { type: "boolean", default: false },
                  cascadeProfile:  { type: "string", default: "balanced", description: "Cascade profile from conduit.config.toml" },
                  conversationId:  { type: "string", description: "Persist messages to this conversation" },
    ...
    "/api/chat/conversations": {
      get: {
        ...
        description: "Returns conversation summaries (no message content). Ordered by most recently updated.",
        operationId: "listConversations",
        parameters: [
          {
            name: "interface",
            in: "query",
            schema: { type: "string", enum: ["chat", "media", "tester"] },
    ...
    "/api/chat/conversations/{id}": {
      get: {
        ...
        responses: {
          "200": { description: "Conversation + full message history (ascending)" },
    ...
    "/api/chat/conversations/{id}/messages/{messageId}": {
      delete: {
        ...
        description: "Deletes the specified message and all messages after it. Used by Edit & Regenerate.",
    ...
    "/api/media/generate": {
      post: {
        ...
        description: "Generates images using DALL-E 3, DALL-E 2, or Stable Diffusion. Rate limited to 20 req/min per IP.",
          ...
          content: {
            "application/json": {
              schema: {
                ...
                properties: {
                  prompt:         { type: "string", minLength: 1, maxLength: 4000, example: "A cat riding a skateboard, photorealistic" },
                  model:          { type: "string", example: "dall-e-3" },
                  size:           { type: "string", pattern: "^\\d+x\\d+$", example: "1024x1024" },
        ...
        responses: {
          ...
          "400": { description: "Unknown model or unconfigured provider" },
    ...
    "/api/media/models": {
      get: {
        ...
        responses: {
          "200": { description: "All image models with supported sizes and cost" }
        }
      }
    },
    ...
    "/api/search": {
      post: {
        ...
        description: "Searches using the first configured provider (SerpAPI or Brave Search). Rate limited to 30 req/min per IP.",
        operationId: "search",
        requestBody: {
          required: true,
          content: {
            "application/json": {
              schema: {
                ...
                required: ["query"],
                properties: {
                  query:      { type: "string", minLength: 1, maxLength: 500, example: "Hono framework benchmarks" },
                  provider:   { type: "string", enum: ["serpapi", "brave"], description: "Specific provider — omit for auto-select" },
    ...
    "/api/search/providers": {
      get: {
        ...
        responses: {
          "200": {
            description: "All known search providers and their configured state",
            content: {
              "application/json": {
                schema: {
                  type: "object",
    ...
    "/api/code/execute": {
      post: {
        ...
        description: "Runs code in an isolated, ephemeral E2B CodeInterpreter sandbox. Supports Python (Jupyter kernel), JavaScript (Deno kernel), and Bash. Rich outputs (matplotlib plots, etc.) are returned as base64 images. Rate limited to 10 req/min per IP.",
          ...
          content: {
            "application/json": {
              schema: {
                ...
                properties: {
                  code:      { type: "string", minLength: 1, maxLength: 100000, example: "print(sum(range(1, 101)))" },
                  runtime:   { type: "string", enum: ["python", "javascript", "bash"], example: "python" },
              ...
              examples: {
                python: {
                  ...
                  value: { code: "print(sum(range(1, 101)))", runtime: "python" }
                },
                javascript: {
                  summary: "JavaScript — fibonacci",
                  value: { code: "const fib = n => n<=1?n:fib(n-1)+fib(n-2); console.log(fib(10));", runtime: "javascript" }
                },
                bash: {
                  summary: "Bash — system info",
                  value: { code: "uname -a && echo 'Sandbox is alive'", runtime: "bash" }
                }
              }
            }
          }
        ...
        responses: {
                  ...
                  properties: {
                    ...
                    outputs: {
                      ...
                      items: {
                        type: "object",
                        properties: {
                          type:     { type: "string", enum: ["text", "image", "error"] },
          ...
          "400": { description: "E2B not configured or unsupported runtime" },
          "429": { description: "Rate limited" },
              ...
              "application/json": {
                schema: {
                  ...
                  properties: {
                    ...
                    configured: { type: "boolean", description: "True if an E2B API key is saved" }
                  }
                }
              }
            }
    ...
    "/api/discovery/probe": {
      post: {
        ...
        description: "Probes a raw key against all known providers in parallel. Returns matched providers and their capabilities. Rate limited to 10 req/min per IP. The key is never stored.",
        ...
        responses: {
          "200": { description: "Probe result with matched providers" },
          "429": { description: "Rate limited" }
        }
      }
    },
    ...
    "/api/models": {
      get: {
        ...
        description: "Returns all models grouped by category. Use these IDs in /api/chat/stream and /api/media/generate.",
        ...
        responses: {
          ...
          "426": { description: "Version lock — update Conduit to continue" }
        }
      }
    },
    ...
    "/api/providers/health": {
      get: {
        ...
        description: "Health of every configured provider including latency, model counts, and capability lists. Cached for 30 seconds per provider.",
                    ...
                    providers: {
                      ...
                      items: {
                        ...
                        properties: {
                          id:              { type: "string" },
                          name:            { type: "string" },
                          status:          { type: "string", enum: ["active", "unconfigured", "invalid_key", "rate_limited", "provider_down", "unreachable"] },
    ...
    "/api/sites/config": {
      get: {
        ...
        description: "Reads the Host header and returns the matching site profile from conduit.config.toml. Used by interfaces on load to determine which UI variant to render.",
            ...
            content: {
              "application/json": {
                schema: {
                  ...
                  properties: {
                    host:    { type: "string" },
                    variant: { type: "string", enum: ["chat", "media", "tester", "default"] }
                  }
                }
              }
            }
    ...
    "/api/sites": {
      get: {
        ...
        responses: {
          "200": { description: "All host → profile mappings from conduit.config.toml" }
        }
      }
    },
    ...
    "/api/license": {
      get: {
        ...
        description: "Returns the cached state from Postgres — does not trigger a fresh manifest fetch.",
            ...
            content: {
              "application/json": {
                schema: {
                  type: "object",
                  properties: {
                    status:           { type: "string", enum: ["ok", "update_required", "unknown"] },
    ...
    "/api/license/refresh": {
      post: {
        ...
        description: "Fetches, verifies, and persists the manifest now instead of waiting for the next scheduled check. Useful after updating Conduit.",
